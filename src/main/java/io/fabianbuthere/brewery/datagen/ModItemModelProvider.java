...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        withExistingParent("brewing_cauldron", modLoc("block/brewing_cauldron_prerendered"))
            .transforms()
            .transform(ItemDisplayContext.GUI)
                .rotation(30, 225, 0)
                .scale(0.65F)
            ...
            .transform(ItemDisplayContext.GROUND)
                ...
                .end()
            .end();
        withExistingParent("distillery_station", modLoc("block/distillery_station_prerendered"))
            .transforms()
            .transform(ItemDisplayContext.GUI)
                .rotation(30, 225, 0)
                .scale(0.65F)
        ...
        withExistingParent("cocktail_station", modLoc("block/cocktail_station"))
                ...
                .end()
                .end();
        withExistingParent("coffee_maker", modLoc("block/coffee_maker"))
                .transforms()
                .transform(ItemDisplayContext.GUI)
                .rotation(30, 225, 0)
                .scale(0.65F)
